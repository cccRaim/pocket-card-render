...
const AUDITS = [
  ...
  ["atomic-publish", "build/test-atomic-publish.mjs"],
  ["atomic-publish-boundaries", "build/audit-atomic-publish-boundaries.mjs"],
  ["effective-render-queue", "build/test_effective_render_queue.py", {}, "python"],
  ["vercel-package-transaction", "build/test-vercel-package.mjs"],
  ["runtime-source-identity", "build/test-runtime-source-identity.mjs"],
  ["full-runtime-sample-selection", "build/test-full-runtime-sample-selection.mjs"],
  ["runtime-port-assets", "build/test-runtime-port-assets.mjs"],
  ["tmp-runtime-sample-selection", "build/test-tmp-runtime-sample-selection.mjs"],
  ["runtime-display-fidelity-sample-selection", "build/test-runtime-display-fidelity-sample-selection.mjs"],
  ["candidate-official-guest-runtime-batch", "build/build-candidate-official-guest-runtime-batch.mjs", {
    PCR_CANDIDATE_GUEST_RUNTIME_CHECK: "1",
  }],
  ["candidate-official-guest-runtime-batch-mutations", "build/test-candidate-official-guest-runtime-batch.mjs"],
  ["gfxreconstruct-vulkan-conversion", "build/test-gfxrecon-vulkan-capture-conversion.mjs"],
  ["candidate-guest-pipeline-state", "build/test-candidate-guest-pipeline-state.mjs"],
  ["candidate-guest-platform-blocker", "build/build-candidate-guest-platform-blocker.mjs", {
    PCR_CANDIDATE_GUEST_PLATFORM_BLOCKER_CHECK: "1",
  }],
  ["candidate-guest-platform-blocker-self-test", "build/build-candidate-guest-platform-blocker.mjs", {
    PCR_CANDIDATE_GUEST_PLATFORM_BLOCKER_SELF_TEST: "1",
  }],
