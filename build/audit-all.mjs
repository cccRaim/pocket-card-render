...
const AUDITS = [
  ...
  ["official-card-future", "build/audit-official-card-future.mjs"],
  ["official-card-ancient", "build/audit-official-card-ancient.mjs"],
  ["official-card-marble", "build/audit-official-card-marble.mjs"],
  ["card-marble-state", "build/test-card-marble.mjs"],
  ["official-card-behaviour-rotation", "build/audit-official-card-behaviour-rotation.mjs"],
  ["card-behaviour-rotation", "build/test-card-behaviour-rotation.mjs"],
  ["three-perspective-zbuffer", "build/audit-three-perspective-zbuffer.mjs"],
  ["three-perspective-zbuffer-tests", "build/test-three-perspective-zbuffer.mjs"],
  ["official-unbound-uniform-boundaries", "build/audit-official-unbound-uniform-boundaries.mjs"],
  ["official-card-msr", "build/audit-official-card-msr.mjs"],
  ["card-msr-state", "build/test-card-msr.mjs"],
  ["official-card-mrr", "build/audit-official-card-mrr.mjs"],
  ["card-mrr-state", "build/test-card-mrr.mjs"],
  ["effect-emit-producer-routing", "build/test-effect-emit-producer-routing.mjs"],
  ...
  ["bloom-pipeline-proof", "build/audit-bloom-pipeline-proof.mjs"],
  ["bloom-pipeline-proof-mutations", "build/test-bloom-pipeline-proof.mjs"],
  ...
  ["final-blit-backend-proof", "build/audit-final-blit-backend-proof.mjs"],
  ["final-blit-backend-proof-mutations", "build/test-final-blit-backend-proof.mjs"],
  ...
  ["rarity-rendering-completeness", "build/audit-rarity-rendering-completeness.mjs"],
  ["rarity-rendering-completeness-mutations", "build/test-rarity-rendering-completeness.mjs"],
  ...
  ["runtime-dispatch-contract", "build/test-runtime-dispatch-contract.mjs"],
  ["official-draw-identity", "build/test-official-draw-identity.mjs"],
  ["immersive-rendering", "build/test-immersive-rendering.mjs"],
  ["shadowbox-transparent-hologram", "build/test-shadowbox-transparent-hologram.mjs"],
  ["transparent-ur-oklab", "build/test-transparent-ur-oklab.mjs"],
  ["shadow-holograms", "build/test-shadow-holograms.mjs"],
  ["mega-sr-rendering", "build/test-mega-sr-rendering.mjs"],
  ["mega-rr-rendering", "build/test-mega-rr-rendering.mjs"],
