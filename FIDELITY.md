...
programs cover 43 of 64 reference layers.” That number must not be renamed, averaged, or presented as
“game fidelity.”
...
| Transpiled official programs | 43/64 | `shader-reverse-engineering` | 21 layers / 11 shader families |
| Promote partial guards from E1 to E2 | 21 E1 layers | `shader-reverse-engineering` | Same 21 layers / 11 families; not additive to the row above |
