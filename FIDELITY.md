...
programs cover 39 of 64 reference layers.” That number must not be renamed, averaged, or presented as
“game fidelity.”
...
| Transpiled official programs | 39/64 | `shader-reverse-engineering` | 25 layers / 12 shader families |
| Promote partial guards from E1 to E2 | 25 E1 layers | `shader-reverse-engineering` | Same 25 layers / 12 families; not additive to the row above |
